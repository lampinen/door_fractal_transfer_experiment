...
distributional_data = main_data %>%
  ...
  complete(location, goal, action, fill=list(action_count=0, action_probability=0.)) %>%
  ungroup()
```
...
distributional_similarity_data = distributional_data %>%
  ...
  mutate(location = location + 1, # so they can be used as 1-indices
         action = action + 1, # so they can be used as 1-indices
         location_2 = ifelse(grepl("square", group), sq_p2_locs[location], tr_p2_locs[location]),
         action_2 = ifelse(grepl("square", group), sq_p2_acts[action], tr_p2_acts[action]),
         location_3 = ifelse(grepl("square", group), sq_p3_locs[location], tr_p3_locs[location]),
         action_3 = ifelse(grepl("square", group), sq_p3_acts[action], tr_p3_acts[action]),
         location_4 = ifelse(grepl("square", group), sq_p4_locs[location], tr_p4_locs[location]),
         action_4 = ifelse(grepl("square", group), sq_p4_acts[action], tr_p4_acts[action]),
         location_5 = ifelse(grepl("square", group), sq_p5_locs[location], tr_p5_locs[location]),
         action_5 = ifelse(grepl("square", group), sq_p5_acts[action], tr_p5_acts[action]),
         location_6 = ifelse(grepl("square", group), sq_p6_locs[location], tr_p6_locs[location]),
         action_6 = ifelse(grepl("square", group), sq_p6_acts[action], tr_p6_acts[action]),
         location_7 = ifelse(grepl("square", group), sq_p7_locs[location], tr_p7_locs[location]),
         action_7 = ifelse(grepl("square", group), sq_p7_acts[action], tr_p7_acts[action]),
         location_8 = ifelse(grepl("square", group), sq_p8_locs[location], tr_p8_locs[location]),
         action_8 = ifelse(grepl("square", group), sq_p8_acts[action], tr_p8_acts[action])) %>%
