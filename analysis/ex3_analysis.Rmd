...
## drag + drop
```{r}
num_dd_assignments_correct_model = lm(num_assignments_correct ~ isomorphic + fractal_num_steps_needed + fractal_Flipping + I(rt/1000), data=s2_joined_question_data %>% filter(question=="drag_drop_on_diagram"))
...
```{r}
ds_correct_model = glm(ds_correct ~ fractal_hexagon_bi + isomorphic, data=s2_joined_question_data)
