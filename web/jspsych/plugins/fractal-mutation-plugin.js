...
jsPsych.plugins['fractal-mutation'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (typeof trial.progress !== 'undefined') {
      $('body').prepend($('<div id="jspsych-progressbar-container"><span>Visual pattern experiment progress</span><div id="jspsych-progressbar-outer"><div id="jspsych-progressbar-inner"></div></div></div>'));
    ...
    function get_percentile_string(start, goal, num_steps) {
        ...
        if (pct == 90) {
            return "You made it in the minimum number of steps!";
        } else if (pct > 60) {
    ...
    var keyboard_callback = function(info) {
        ...
        animate_mutation(mutagen_loc, function() {
            ...
            if (current_location == trial.goal) {
                setTimeout(function() {
                    num_steps = action_history.length;
