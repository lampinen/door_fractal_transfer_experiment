...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figures/similarity_likert.png}\\
\includegraphics[width=0.7\textwidth]{figures/correspondence_suspect.png}\\
\includegraphics[width=0.7\textwidth]{figures/when_noticed.png}
\end{figure}
\end{frame}

\againframe<1-6>{iso_bet_B}

\againframe<2,4->{iso_within_task}

\begin{frame}{What's up with ``one task helpful for other''}
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figures/one_task_helpful.png}
\end{figure}
...
\item<3-> This transfer may not require awareness. 
\end{itemize}
\end{frame}
