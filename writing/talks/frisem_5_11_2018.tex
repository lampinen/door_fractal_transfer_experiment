...
\only<1>{
    ...
    \includegraphics[width=0.9\textwidth]{figures/ex3/cddnac_by_iso.png}
}\only<3>{
    \includegraphics[width=0.9\textwidth]{figures/ex3/cddnac_by_iso_by_group.png}
}
\end{figure}
\uncover<2->{\scriptsize Error bars represent parametric 95\%-confidence intervals}
\note{< 40 subjects in this, < 20 s in isomorphic condition...}
\end{frame}

\begin{frame}{Only weakly related to performance and policy alignment}
\begin{figure}
\centering
\only<1>{
    \includegraphics[width=0.9\textwidth]{figures/ex3/cddnac_by_iso_by_ns.png}
}\only<2>{
    \includegraphics[width=0.9\textwidth]{figures/ex3/cddnac_by_iso_minl1.png}
}
\end{figure}
\uncover<2->{\scriptsize Error bars represent parametric 95\%-confidence intervals}
\end{frame}
...
\only<1>{
    ...
    \includegraphics[width=0.9\textwidth]{figures/ex3/sl_by_iso_minl1.png}
}
\end{figure}
