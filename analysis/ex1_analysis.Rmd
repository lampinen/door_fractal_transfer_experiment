...
distributional_data = main_data %>%
  group_by(isomorphic, fractal_square_cycles, group, subject_id, trial_type, location, goal, action) %>% 
  summarize(action_count = n()) %>%
  ungroup() %>%
  group_by(isomorphic, fractal_square_cycles, group, subject_id, trial_type, location, goal) %>% 
  mutate(action_probability = action_count/sum(action_count)) %>%
  ungroup() %>%
  group_by(isomorphic, fractal_square_cycles, group, subject_id, trial_type) %>% 
