...
Time dependent:
```{r}
dihedral_basic_time_dependent_model = glmer(action_correct ~ isomorphic + session_c + I(session_c^2) + correct_action + trial_type + trial_index_by_type_z + I(trial_index_by_type_z^2)  + (1 +  session_c | subject_id), family=binomial, data=dihedral_data)
