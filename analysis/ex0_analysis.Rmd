...
for (i in 1:num_subjects) {
  ...
  for (s in 0:2) {
    ...
    for (trial_i in 1:length(main_d_list)) {
      this_trial = main_d_list[trial_i][[1]]
      ...
      if (this_trial$trial_type == "two-door-navigation" | this_trial$trial_type == "fractal-mutation") {
        ...
        this_trial_d$door_history = this_trial$door_history
        this_trial_d$action_history = this_trial$action_history
        this_trial_d$location_history = this_trial$location_history
        this_trial_d$location_rts = this_trial$location_rts
